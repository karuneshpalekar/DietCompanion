...
class Config {
    ...
    var dietTypeListPath = DEFAULT_DIET_TYPE_LIST_PATH
    /** Id for padding.  */
    var pad = PAD_ID
    ...
    companion object {
        private const val DEFAULT_LOCAL_MODEL_PATH = "recommendation_cnn_i10i32o100.tflite"
        private const val DEFAULT_MOVIE_LIST_PATH = "sorted_diet_vocab.json"
        private const val DEFAULT_DIET_TYPE_LIST_PATH = "diet_type_vocab.txt"

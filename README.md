...
# Note : Since the application is Non-Production-Ready it is built to support Android Smartphones having screen sizes greater than 6 inch and having an sdk version 29 ,i.e, Android Q . For testing you can make use of Smartphones satisfying both this condition or can make use on an emulator generating the required conditions.
